...
public class StudentGroup implements StudentArrayOperation {
	...
	public void setStudent(Student student, int index) {
		// Add your implementation here
		if(index<0||index>=this.student.length||student==NULL)
			throw new IllegalArgumentException();
		else
	...
	public void addLast(Student student) {
		...
		if(student==null){
			...
			students1[this.students.length]=this.students[this.student.length-1];
			student1[this.student.length+1]=this.students[this.students.length];
			this.students=new Student[students1.length];
			this.students=students1;
		}
	}
